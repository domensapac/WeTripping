  ...
  children: React.ReactNode;
    ...
    return (
        <div className="tracking-[1px] flex min-h-screen w-full text-gray-400">
            <div className="hidden md:flex md:w-1/3 lg:w-1/2 bg-cover bg-[url('/test_bg.png')] ...">    
            </div>
            <div className="bg-cover bg-[url('/test_bg.png')] md:bg-none w-full md:w-2/3 lg:w-1/2 flex justify-center items-center">
