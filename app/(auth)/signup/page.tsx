...
export default async function SignUp(){
    return (
        <div>
            <span className="flex text-3xl p-3 pt-0 mb-5 w-full justify-center text-black font-medium"> Sign Up </span>
            <div className="flex justify-center items-center ">
                <span className="hover:bg-[#A8D8FF] p-1 px-2 hover:border-white border-gray-300 border-1 flex rounded-full p-1 hover:cursor-pointer items-center me-1 text-gray-700"> 
                ...
                <span className="hover:bg-[#A8D8FF] p-1 px-2 hover:border-white border-gray-300 border-1 flex rounded-full p-1 hover:cursor-pointer items-center ms-1 text-gray-700"> 
                    <svg className="p-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="25px" height="25px">
